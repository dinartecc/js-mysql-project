...
insert into producto ( SKU, nombre, ID_subcategoria, ID_marca, margen_ganancia, porcentaje_impuestos ) values ( '000000000000', 'Borrado', 0, 0, 0, 0 );
insert into lotes ( ID_lotes, SKU, cantidad, costo, fecha_ingreso, ID_almacen, fecha_caducidad ) values ( 0, '000000000000', 0, 0, '1970-01-01', 0, '1970-01-01') ;
