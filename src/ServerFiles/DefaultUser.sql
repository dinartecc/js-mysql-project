...
insert into producto ( SKU, nombre, ID_subcategoria, ID_marca, margen_ganancia, porcentaje_impuestos, vigilar, minimo_stock ) values ( '00000000000', 'Borrado', 0, 0, 0, 0, 0, 0 );
