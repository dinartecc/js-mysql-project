...
create table if not exists DescuentoProducto (
	ID_descproducto int unsigned not null auto_increment,
    nombre varchar(30) not null,
...
create table if not exists Producto_DescuentoProducto (
	...
	constraint PK_pro_dpr primary key (ID_producto, ID_descproducto),
...
create table if not exists Producto_Proveedor(
	...
	constraint PK_pro_dpr primary key (ID_producto, ID_proveedor),
...
create table if not exists Lotes (
	ID_lotes int unsigned not null auto_increment,
    ID_producto int unsigned not null,
...
create table if not exists DescuentoGeneral (
	ID_descgeneral int unsigned not null auto_increment,
    nombre varchar(30) not null,
    porcentaje numeric (4,4) unsigned not null,
    activo boolean default false,
...
create table if not exists Venta_DescuentoGeneral (
    ...
    ID_venta int unsigned not null,
    constraint PK_ven_dge primary key (ID_descgeneral, ID_venta),
...
create table if not exists Venta_Lotes (
	ID_lotes int unsigned not null,
    ID_venta int unsigned not null,
    constraint PK_ven_lot primary key (ID_lotes, ID_venta),
...
create table if not exists Compra_Lotes (
	ID_lotes int unsigned not null,
    ID_compra int unsigned not null,
    constraint PK_com_lot primary key (ID_lotes, ID_compra),
